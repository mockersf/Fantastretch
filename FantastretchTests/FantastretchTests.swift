...
class FantastretchTests: XCTestCase {
    ...
    func testStretchInitializationSucceeds() {
        ...
        let positiveRatingStretch = Exercise(name: "Positive", explanation: "", photo: nil, rating: 5, sides: Repeat.allCases.first!, muscle: Muscle.allCases.first!, id: nil)
    ...
    func testStretchInitializationFails() {
        ...
        // Empty String
        let emptyStringStretch = Exercise(name: "", explanation: "", photo: nil, rating: 1, sides: Repeat.allCases.first!, muscle: Muscle.allCases.first!, id: nil)
        XCTAssertNil(emptyStringStretch)

        // Rating exceeds maximum
        let largeRatingStretch = Exercise(name: "", explanation: "", photo: nil, rating: 6, sides: Repeat.allCases.first!, muscle: Muscle.allCases.first!, id: nil)
